  ...
  handleGetDetails = type => {
    ...
    switch (type) {
      ...
      case "tv":
        return (
          <div className="movie wow fadeIn" data-wow-duration="2s">
            {this.props.TVDetails.loaded ? null : <Loader />}
            <div
              className="movie__backdrop"
              style={{
                backgroundImage: `url(${backdrop})`
            ...
            >
              ...
              <div className="movie__info">
                <h3 className="movie__heading">{TVDetails.original_name}</h3>
                <p className="movie__rating">
                  Rating
                  <span>
                    <i
                      style={TVDetails.vote_average >= 7.5 ? superFilm : null}
                      className="fas fa-star"
                    />
                ...
                <p className="movie__release">
                  ...
                  <span>
                    ...
                    {TVDetails.first_air_date <= date ? " | released" : null}
                  </span>
                </p>
              </div>
            </div>
            <div className="movie__overview">
              <p className="movie__overview-heading">Overview</p>
              <p className="movie__overview-paragraph">{TVDetails.overview}</p>
            </div>
            <div className="movie__cast">
              <p className="movie__cast-heading">Cast</p>
              {actors.length > 0 && (
